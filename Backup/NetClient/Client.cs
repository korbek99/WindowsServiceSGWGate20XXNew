...
namespace NetClient
{
    public partial class Client : BaseForm
    {
        ...
        {
            lblMensaje.Text = "No Hay Mensajes";
            cboIP.Text = "192.168.10.225";
            hourMinute = DateTime.Now.ToString("HH:mm");
            int_filaMatrix = 1;
            btnRecord.Enabled =false;
            btnCapPic.Enabled =false;
            btnReplay.Enabled =false;
            btnNextivaTest.Enabled =false;
            ...
            switch (_iAlarmType)
            {
                ...
                case AlarmConstMsgType.ALARM_VCA_INFO:
                    ...
                    //{
                        ...
                        CustomerCompanyBF oBjCos = new CustomerCompanyBF();
                        DataSet dsCustumer = new DataSet();

                        dsCustumer = oBjCos.CustomerCompanyByCustomerIPBF(IPCustomer);

                        if (dsCustumer.Tables[0].Rows.Count > 0)
                        {
                            foreach (DataRow dataRow in dsCustumer.Tables[0].Rows)
                            {
                                CustomerID = Convert.ToInt32(dataRow["CustomerCompanyID"].ToString());
                            }
                        }

                        hourMinuteAux = DateTime.Now.ToString("HH:mm");


                        //if (hourMinuteAux != hourMinute)
                        //{
                            ...
                            //AlarmsArray[int_filaMatrix][0] = Convert.ToString(objeto.AlarmInfChannel);
                            //AlarmsArray[int_filaMatrix][1] = Convert.ToString(objeto.AlarmInfEventType);
                            //AlarmsArray[int_filaMatrix][2] = Convert.ToString(objeto.AlarmInfID);
                            //AlarmsArray[int_filaMatrix][3] = Convert.ToString(objeto.AlarmInfIDE);
                            //AlarmsArray[int_filaMatrix][4] = Convert.ToString(objeto.AlarmInfrctTarget);
                            //AlarmsArray[int_filaMatrix][5] = Convert.ToString(objeto.AlarmInfRuleID);
                            //AlarmsArray[int_filaMatrix][6] = Convert.ToString(objeto.AlarmInfRuleDescrip);
                            //AlarmsArray[int_filaMatrix][7] = Convert.ToString(objeto.AlarmInfState);
                            //AlarmsArray[int_filaMatrix][8] = Convert.ToString(objeto.AlarmInfTargetDirection);
                            //AlarmsArray[int_filaMatrix][9] = Convert.ToString(objeto.AlarmInfTargetSpeed);
                            //AlarmsArray[int_filaMatrix][10] = Convert.ToString(objeto.AlarmInfTargetType);
                            //AlarmsArray[int_filaMatrix][11] = Convert.ToString(objeto.AlarmInTargetID);
                            //AlarmsArray[int_filaMatrix][12] = Convert.ToString(objeto.AlarmInfDescription);
                            //AlarmsArray[int_filaMatrix][13] = Convert.ToString(objeto.AlarmInfCostuCompany);
        ...
        {
            if (b_IniAplication == true)
            {
                int iRetos = NVSSDK.NetClient_NetLogQuery(int_LogonID, ref m_logquery);
                
            }
        }

        private void InitializeTimerAutomatico()
        {
            int iAlarmIndex = 6;
            int iBufSize = 128;
            int cantidadtrips = 1;
            ...
            try
            {
                int iRets = NVSSDK.NetClient_VCAGetAlarmInfo(int_LogonID, iAlarmIndex, ref m_lpbuf, iBufSize);
                if (iRets < 0)
                {
                    // MessageBox.Show("Ocurrio un error envio alarma");
                    lblMensaje.Text = "Ocurrio un error envio alarma";
                ...
                {
                    objeto.AlarmInfChannel = 1; // m_lpbuf.m_iChannel;
                    objeto.AlarmInfEventType = m_lpbuf.m_iEventType;
                    objeto.AlarmInfID = cantidadtrips; // m_lpbuf.m_iID;
                    objeto.AlarmInfIDE = m_lpbuf.m_iID;
                    objeto.AlarmInfrctTarget = "";
                    objeto.AlarmInfRuleID = VCAConfiguration.VCA_RULE0_TRIPWIRE; //m_lpbuf.m_iRuleID; 
                    objeto.AlarmInfRuleDescrip = Convert.ToString(m_lpbuf.m_uiTargetID);
                    objeto.AlarmInfState = m_lpbuf.m_iState;
                    objeto.AlarmInfTargetDirection = m_lpbuf.m_iTargetDirection;
                    objeto.AlarmInfTargetSpeed = m_lpbuf.m_iTargetSpeed;
                    objeto.AlarmInfTargetType = m_lpbuf.m_iTargetType;
                    objeto.AlarmInTargetID = m_lpbuf.m_uiTargetID;

                    //if (IDETrips != Convert.ToString(objeto.AlarmInTargetID))
                    //{ 
                    if (objeto.AlarmInTargetID > 0)
                    {
                        //IDETrips = "";
                        //IDETrips = Convert.ToString(objeto.AlarmInTargetID) + cantidadtrips;
                        lblMensaje.Text = "alarma " + m_lpbuf.m_uiTargetID + " Cant :" + cantidadtrips;
                        cantidadtrips++;
                        if (SentNextivaAutomatico(objeto) == true)
                        {
                    ...
                    {
                        lblMensaje.Text = "";
                        lblMensaje.Text = "Modo Automatico..";
                    }
                    // }    
                }
            }
        ...
        private Boolean SentNextivaAutomatico(AlarmInfomation objeto)
        {
            ...
            lista.Add(new AlarmNextiva()
            {
                ...
                AlarmSentEstado = 1,
                AlarmSentCustCompanyID =objeto.AlarmInfCostuCompany
        ...
        //    lista.Add(new AlarmNextiva()
        //    {
        //        AlarmSentIDE = objeto.AlarmInfIDE,
        //        AlarmSentChannel = objeto.AlarmInfChannel,
        //        AlarmSentState = objeto.AlarmInfState,
        //        AlarmSentventType = objeto.AlarmInfTargetType,
        //        AlarmSentRuleID = objeto.AlarmInfRuleID,
        ...
        private void btnNextivaTest_Click(object sender, EventArgs e)
        {
            DataNextivaBF ObtData = new DataNextivaBF();
            //AlarmNextiva enti = new AlarmNextiva();
            //enti.AlarmSentIDE = 1;
            //enti.AlarmSentChannel = 1;
            //enti.AlarmSentState = 1;
            //enti.AlarmSentventType = 1;
            //enti.AlarmSentRuleID = 1;
            //enti.AlarmSentTargetID = 1;
            //enti.AlarmSentTargetType = 1;
            //enti.AlarmSentrctTarget = "";
            //enti.AlarmSentTargetSpeed = 1;
            //enti.AlarmSentTargetDirection = 1;
            //enti.AlarmSentEstado = 1;
            ...
            lista.Add(new AlarmNextiva()
            {
                ...
                AlarmSentventType = 1,
                AlarmSentRuleID = 6,
                AlarmSentRuleDescrip = VerifyVCAAlarms(6),
                AlarmSentTargetID = 1,
                AlarmSentTargetType = 1,
                AlarmSentrctTarget = "",
                AlarmSentTargetSpeed = 1,
                AlarmSentTargetDirection = 1,
                AlarmSentEstado = 1
            });
            lista.Add(new AlarmNextiva()
            {
            ...
            if (ObtData.SendDataCameraToNextivaBF(lista) == true)
            {
                MessageBox.Show("proceso se realizo con exito");
            }
            else
            {
                MessageBox.Show("Ocurrio un error en proceso");
            }
        }

        private void lbAlarmlistBox_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        {
            TriggersCamera form = new TriggersCamera();
            form.Show();
        }
    }
}
