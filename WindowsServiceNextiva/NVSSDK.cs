...
namespace NetClient
{
    ...
    {       
        ...
        public static extern Int32 NetClient_GetMediaStreamClient(  Int32 _iLogonID,
                                                                    Int32 _iChannel,
                                                                    ref Char[] _cClientIP,
                                                                    ref Int16 _iClientPort,
                                                                    ref Int32 _iStreamType);


        [DllImport("NVSSDK.dll")]
        public static extern Int32 NetClient_GetManagerServersInfo(
                      Int32 _iLogonID,
                      ref Char[] _cRegSvrIP,
                      ref Int16 _wdRegPort,
                      ref Char[] _cHeartSvrIP,
                      ref Int16 _wdHeartPort,
                      ref Char[] _cAlarmSvrIP,
                      ref Int16 _wdAlarmPort
                      );
        ...
        [DllImport("NVSSDK.dll")]
        public static extern Int32 NetClient_GetIpPropertyEx(Int32 _iLogonID, ref char[] _cNewSvrIP, ref char[] _cMask, ref char[] _cGateway, ref char[] _cDNS, ref char[] _cBackDNS);

        [DllImport("NVSSDK.dll")]
        public static extern Int32 NetClient_GetIpProperty(Int32 _iLogonID,
                                                           ref char[] _cMAC,
                                                           ref char[] _cMask,
                                                           ref char[] _cGateway,
                                                           ref char[] _cDNS);
       ...
       [DllImport("NVSSDK.dll")]
        ...
        //Para Obtener Protocol Type
        [DllImport("NVSSDK.dll")]
        public static extern Int32 NetClient_GetComFormat_V1(Int32 _iLogonID, Int32 _iComPort, string _cDeviceType, string _cComFormat, Int32 _iWorkMode);

        // Obtiene alarmas de camara 
        [DllImport("NVSSDK.dll")]
        public static extern Int32 NetClient_GetAlarmMotionDetectionCamera();

        [DllImport("NVSSDK.dll", SetLastError = true)]
        public static extern Int32 NetClient_VCAGetAlarmInfo(Int32 _iLogonID, Int32 _iAlarmIndex, ref VCA_TAlarmInfo _lpBuf, Int32 _iBufSize);
        [DllImport("NVSSDK.dll", SetLastError = true)]


        //[DllImport("NVSSDK.dll")]

        //public static extern Int32 NetClient_VCAGetAlarmInfo(Int32 _iLogonID, Int32 _iAlarmIndex, ref NVS_FILE_LPBUF _lpBuf, Int32 _iBufSize);

        //[DllImport("NVSSDK.dll", SetLastError = true)]
        //public static extern Int32 NetClient_VCAGetAlarmInfoBeta(Int32 _iLogonID, Int32 _iAlarmIndex, ref VCA_TAlarmInfo _lpBuf, Int32 _iBufSize);

        //[DllImport("NVSSDK.dll")]

        //public static extern Int32 NetClient_VCAGetAlarmInfoTwo(Int32 _iLogonID, Int32 _iAlarmIndex, ref VCA_TAlarmInfo _lpBuf, Int32 _iBufSize);

        //[DllImport("NVSSDK.dll")]
        public static extern Int32 NetClient_NetLogQuery(int _iLogonID, ref PNVS_LOG_QUERY _logQuery);

        [DllImport("NVSSDK.dll")]
        public static extern Int32 NetClient_NetLogGetLogfile(int _iLogonID,int   _iLogIndex, ref PNVS_LOG_QUERY_BETA _logQuery);

        [DllImport("NVSSDK.dll")]
        public static extern Int32 NetClient_NetLogGetLogCount(Int32 _iLogonID, ref Int32 _iTotalCount, ref Int32 _iCurrentCount);


//        int __stdcall NetClient_NetLogGetLogCount(
//  int       _iLogonID
//  int*      _iTotalCount
//  int*      _iCurrentCount
//);
        ...
        public static extern Int32 NetClient_NetFileDownloadByTimeSpanEx(ref UInt32 _uiConID, 
                                                                         ...
                                                                         Int32 _iSpeed);
        [DllImport("NVSSDK.dll")]
        public static extern Int32 NetClient_GetAlarmOutput(Int32 _iLogonID, Int32 _iChannelNum, ref Int32 _ulAlarmOutput);

         //       int __stdcall NetClient_GetAlarmOutput(

         //   int                      _iLogonID,_iLogonID
         //   Return value by NetClient_Logon

         //   int                      _iChannelNum,_iChannelNum
         //   Channel number

         //   unsigned long*           _ulAlarmOutput_ulAlarmOutput
         //   [OUT]Alarm output triggering, every bit corresponds with an alarm output port.
         //   If it is 1, then the channel triggers the port, if 0, the channel does not trigger the port
        ...
        //[DllImport("NVSSDK.dll", SetLastError = true)]
        //public static extern Int32 NetClient_GetMediaStreamClient(int  _iLogonID,
        //                                                          int  _iChannel,
        //                                                          ref char _cClientIP,
        //                                                          ref short _iClientPort,
        //                                                          ref int _iStreamType);
        [DllImport("NVSSDK.dll", SetLastError = true)]
        public static extern Int32 NetClient_GetMediaStreamClient(Int32 _iLogonID, Int32 _iChannel, ref sbyte _cClientIP, ref int _iClientPort, ref int _iStreamType);



        //[DllImport("NVSSDK.dll", SetLastError = true)]
        //public static extern Int32 NetClient_Get3GDeviceStatus(
        //        int _iLogonID,
        //        int _i3GDeviceType,
        //        int _iStatus,
        //        int _iIntensity,
        ...
        [DllImport("NVSSDK.dll", SetLastError = true)]
        public static extern Int32 NetClient_GetComServer(UInt32 _iLogonID, ref char[] _cComServer, ref Int32 _iComServerPort);
        ...
        [DllImport("NVSSDK.dll")]
        public static extern Int32 NetClient_NetFileGetMapStoreDevice(Int32 _iLogonID, ref PNVS_NFS_DEV _storeDev);

        //[DllImport("NVSSDK.dll")]
        //public static extern Int32 NetClient_GetMediaStreamClient(Int32 _iLogonID,Int32 _iChannel, ref char[] _cClientIP,ref short _iClientPort,ref Int32 _iStreamType);
