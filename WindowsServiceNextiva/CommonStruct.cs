...
namespace NetClient
{
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct NVS_FILE_LPBUF  
    {
        public int m_iID;
        public int m_iChannel;
        public int m_iState;
        public int m_iEventType;
        public int m_iRuleID;
        public int m_uiTargetID;
        public int m_iTargetType;     
        RECT          m_rctTarget;
        public int m_iTargetSpeed;
        public int m_iTargetDirection;
    }
    ...
    [StructLayout(LayoutKind.Sequential)]
    struct PNVS_LOG_QUERY_BETA
    {
        public int iChannelNo;
        public int m_iLogType;
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct PNVS_LOG_QUERY
    {
        public int m_iChannelNo;
        public int m_iLogType;
        public int m_iLanguage;
        NVS_FILE_TIME   m_struStartTime;
        NVS_FILE_TIME   m_struStopTime;
        public int m_iPageSize;
        public int m_iPageNo;
    };
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    struct VCA_ALARMINFORMATION
    {
        public int m_iLogonID;
        public int m_iAlarmIndex;
        public string m_lpBuf;
   ...
   // [StructLayout(LayoutKind.Sequential)]
    public class PNVS_NFS_DEV_NEW
    {
        public string cDeviceIP = new string(new char[16]);
        public string cStorePath = new string(new char[250]);
        public string cUsername = new string(new char[16]);
    ...
    //    public Char[] cNvsName;
    //    [MarshalAs(UnmanagedType.ByValArray, SizeConst = 16)]
    //    public Char[] cAccontPasswd;

    //    public bool BIsTalking;
    //    public int iTalkType;
    //    [MarshalAs(UnmanagedType.ByValArray, SizeConst = 256)]
    //    public Char[] cTalkInputFile;
    //    public 
    //    public int uiInterTalkID;
    ...
    public struct DEVICE_INFO
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 16)]
        public Char[] cAccontPasswd;
        //public HTREEITEM hItem = new HTREEITEM();
        public bool bIstalking;
        public int iTalking;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 256)]
        public Char[] ctalkInputFile;
        public System.IntPtr htreadTalk;
        public System.IntPtr hEventQuitTalking;
        public int uiInterTalkID;
    }
