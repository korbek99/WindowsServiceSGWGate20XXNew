<%--<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="WebSWGEstadisticas.GIEstadisticas.Empresa.index" %>--%>
<%@ Page Title="Ingreso" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="index.aspx.cs" Inherits="WebSWGEstadisticas.GIEstadisticas.Empresa.index" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
        <div id="contenedor">
        <div id="top">SISTEMA DE ESTADISTICAS  - MODULO INGRESO DE EMPRESAS</div>
